...
const CategoryManagement = ({
    ...
    // Fetch categories from API with pagination
    const fetchCategories = useCallback(async (page, search, perPage) => {
    ...
    // Fetch categories when page or search changes
    useEffect(() => {
        fetchCategories(pagination.currentPage, debouncedSearch, pagination.perPage);
    }, [pagination.currentPage, debouncedSearch, pagination.perPage, fetchCategories]);
