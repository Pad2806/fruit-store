...
const ProductManagement = ({
    ...
    // Fetch products from API with pagination and search
    const fetchProducts = useCallback(async (page, search, perPage) => {
        ...
        try {
            setProductsLoading(true);
            setProducts([]); // Clear old data immediately
    ...
    // Fetch products when page or search changes
    useEffect(() => {
        fetchProducts(pagination.currentPage, debouncedSearch, pagination.perPage);
    }, [pagination.currentPage, debouncedSearch, pagination.perPage, fetchProducts]);
