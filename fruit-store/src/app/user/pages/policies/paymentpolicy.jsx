        ...
        <section className={styles.section}>
          ...
          <article className={styles.card}>
            ...
            <div className={styles.methods}>
              ...
              <div className={styles.methodCard}>
                <div className={styles.methodIcon}>💳</div>
                <h3 className={styles.h3Accent}>Quẹt thẻ tại cửa hàng</h3>
          ...
          <article className={styles.card}>
            ...
            <div className={styles.walletGrid}>
              <div className={styles.walletCard}>
                <div className={styles.walletLogo}>M</div>
                <h4 className={styles.h4}>MoMo</h4>
                <p>Quét mã QR hoặc liên kết ví</p>
              </div>
              <div className={styles.walletCard}>
                <div className={styles.walletLogo}>Z</div>
                <h4 className={styles.h4}>ZaloPay</h4>
                <p>Thanh toán nhanh qua Zalo</p>
              </div>
              <div className={styles.walletCard}>
              ...
              <div className={styles.walletCard}>
                <div className={styles.walletLogo}>S</div>
                <h4 className={styles.h4}>ShopeePay</h4>
                <p>Tích lũy xu khi thanh toán</p>
              </div>
            </div>
