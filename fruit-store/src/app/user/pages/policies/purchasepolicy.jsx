...
import styles from "./purchasepolicy.module.scss";
            ...
            <main className={styles.content}>
                <section className={styles.section}>
                    ...
                    <article className={styles.card}>
                        ...
                        <p>
                            <strong>Nội thành TP.HCM:</strong> Giao hàng trong vòng 2-4 giờ kể từ khi xác nhận đơn hàng.
                        </p>
                        <p>
                            <strong>Ngoại thành và các tỉnh:</strong> Giao hàng trong vòng 1-3 ngày làm việc tùy khu vực.
                        </p>
                        <p>
                    ...
                    <article className={styles.card}>
                        ...
                        <div className={styles.table}>
                            ...
                            <div className={styles.tableRow}>
                                <div className={styles.cell}>Nội thành HCM</div>
                                <div className={styles.cell}>Đơn từ 500.000đ</div>
                                <div className={`${styles.cell} ${styles.free}`}>Miễn phí</div>
                            </div>

                            <div className={styles.tableRow}>
                                <div className={styles.cell}>Nội thành HCM</div>
                                <div className={styles.cell}>Đơn dưới 500.000đ</div>
                                <div className={styles.cell}>30.000đ</div>
                            </div>

                            <div className={styles.tableRow}>
                                <div className={styles.cell}>Ngoại thành &amp; tỉnh</div>
                                <div className={styles.cell}>Tùy khoảng cách</div>
                                <div className={styles.cell}>Liên hệ</div>
                            </div>
                        </div>
                    </article>
